...
def get_argument_parser():
    ...
    parser.add_argument('--lr_min', default=10, type=float, help='Number of epochs to update the learning rate.')
    ...
    parser.add_argument('--backbone_path', type=str, default='original_updown_backbone.pth', help='path to the pre-trained backbone net')
    parser.add_argument('--backbone_source', type=str, default='detector', help='the source of the backbone model, detector|imagenet')
    parser.add_argument('--warmup_epochs', type=int, default=1, help='The number of warmup epochs using mean vse loss')
    ...
    parser.add_argument('--seed', default=6174, type=int)
    ...
    parser.add_argument('--temperature', type=float, default=0.1,
                        help='inversed temperature of softmax in pooling.')    
    parser.add_argument('--topk_cross', type=float, default=128,
                        help='inversed temperature of softmax in pooling.') 
    parser.add_argument('--notes', default=None, type=str,
                        help='备注你的参数')  
    parser.add_argument('--num_attribute', default=300, type=int,
                        help='num_attribute=300')  
    parser.add_argument('--change_epoch', default=25, type=int,
                        help='which wpoch change lr') 
